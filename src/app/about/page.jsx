  ...
  return (
    ...
    >
      ...
      <div ref={containerRef} className="h-full overflow-scroll flex">
        {/* text container */}
        <div
          className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex 
        ...
        >
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-xl">
              ...
              quas corrupti magni vel, sapiente veniam? Dicta adipisci modi,
              quod earum natus molestias sapiente soluta, aliquid voluptate id
              nemo numquam possimus.
            </p>
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/6 flex flex-1 items-center justify-center">
                  ...
                  <div className="w-1 h-full bg-gray-600 rounded relative">
                    {/* line circle  */}
                    <div
                      className="absolute w-5 h-5 ring-red-400 
