        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex 
          ...
          <div className='flex flex-col gap-12 justify-center'>
            ...
            <p className='text-xl'>
              ...
              Quos quas corrupti magni vel, sapiente veniam? Dicta adipisci modi,
              quod earum natus molestias sapiente soluta, aliquid voluptate id nemo numquam
              possimus.
            </p>
          ...
          <div className=''>
            <div className='flex flex-col gap-12 justify-center'>
              ...
              <div className='flex gap-4 flex-wrap'>
                <div className="rounded  p-2 text-sm cursor-pointer bg-black 
